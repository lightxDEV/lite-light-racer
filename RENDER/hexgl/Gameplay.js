...
RENDER.hexgl.Gameplay = function(opts)
{
	var self = this;
...
RENDER.hexgl.Gameplay.prototype.simu = function()
{
...
RENDER.hexgl.Gameplay.prototype.start = function(opts)
{
	this.finishTime = null;
	this.score = null;
	this.lap = 1;
	...
	this.raceData = new RENDER.hexgl.RaceData(this.track.name, this.mode, this.shipControls);
	if(this.mode == 'replay')
	{
...
RENDER.hexgl.Gameplay.prototype.end = function(result)
{
...
RENDER.hexgl.Gameplay.prototype.update = function()
{
...
RENDER.hexgl.Gameplay.prototype.checkPoint = function()
{
