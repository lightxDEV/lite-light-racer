...
RENDER.hexgl.ShipEffects = function(opts)
{
	...
	if(this.useParticles)
	{
		...
		this.particles = {
			...
			leftSparks: new RENDER.threejs.Particles(
			{
			...
			leftClouds: new RENDER.threejs.Particles(
			{
				opacity: 0.8,
				tint: 0xffffff,
				color: 0x666666,
			...
			rightSparks: new RENDER.threejs.Particles(
			{
				randomness: new THREE.Vector3(0.4,0.4,0.4),
				tint: 0xffffff,
				color: 0xffc000,
			...
			rightClouds: new RENDER.threejs.Particles(
			{
				opacity: 0.8,
				tint: 0xffffff,
				color: 0x666666,
...
RENDER.hexgl.ShipEffects.prototype.update = function(dt)
{
