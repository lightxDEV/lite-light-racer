...
RENDER.hexgl.HUD = function(opts)
{
	var self = this;
...
RENDER.hexgl.HUD.prototype.resize = function(w, h)
{
	this.width = w;
	this.height = h;
	this.canvas.width = w;
...
RENDER.hexgl.HUD.prototype.display = function(msg, duration)
{
	this.messageTiming = 0;
...
RENDER.hexgl.HUD.prototype.updateLap = function(current, total)
{
	this.lap = current + this.lapSeparator + total;
}

RENDER.hexgl.HUD.prototype.resetLap = function()
{
	this.lap = "";
}

RENDER.hexgl.HUD.prototype.updateTime = function(time)
{
	this.time = this.timeSeparators[0] + time.m + this.timeSeparators[1] + time.s + this.timeSeparators[2] + time.ms + this.timeSeparators[3];
}

RENDER.hexgl.HUD.prototype.resetTime = function()
{
	this.time = "";
}

RENDER.hexgl.HUD.prototype.update = function(speed, speedRatio, shield, shieldRatio)
{
