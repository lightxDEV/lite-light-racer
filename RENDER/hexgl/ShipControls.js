...
RENDER.hexgl.ShipControls = function(ctx)
{
	var self = this;
	...
	if(ctx.controlType == 1 && RENDER.controllers.TouchController.isCompatible())
	{
		this.touchController = new RENDER.controllers.TouchController(
	...
	else if(ctx.controlType == 4 && RENDER.controllers.OrientationController.isCompatible())
	{
		this.orientationController = new RENDER.controllers.OrientationController(
			domElement, true,
			function(state, touch, event){
				if(event.touches.length >= 4)
					window.location.reload(false);
	...
	else if(ctx.controlType == 3 && RENDER.controllers.GamepadController.isCompatible())
	{
		this.gamepadController = new RENDER.controllers.GamepadController(
      function(controller){
...
RENDER.hexgl.ShipControls.prototype.control = function(threeMesh)
{
	this.mesh = threeMesh;
...
RENDER.hexgl.ShipControls.prototype.reset = function(position, rotation)
{
...
RENDER.hexgl.ShipControls.prototype.terminate = function()
{
	this.destroy();
...
RENDER.hexgl.ShipControls.prototype.destroy = function()
{
	RENDER.Audio.play('destroyed');
	RENDER.Audio.stop('bg');
	RENDER.Audio.stop('wind');
...
RENDER.hexgl.ShipControls.prototype.fall = function()
{
	this.active = false;
	this.collision.front = false;
	this.collision.left = false;
...
RENDER.hexgl.ShipControls.prototype.update = function(dt)
{
	if(this.falling)
	{
	...
	RENDER.Audio.setListenerPos(this.movement);
	RENDER.Audio.setListenerVelocity(this.currentVelocity);
};

RENDER.hexgl.ShipControls.prototype.teleport = function(pos, quat)
{
...
RENDER.hexgl.ShipControls.prototype.boosterCheck = function(dt)
{
...
RENDER.hexgl.ShipControls.prototype.collisionCheck = function(dt)
{
...
RENDER.hexgl.ShipControls.prototype.heightCheck = function(dt)
{
...
RENDER.hexgl.ShipControls.prototype.getRealSpeed = function(scale)
{
	return Math.round(
...
RENDER.hexgl.ShipControls.prototype.getRealSpeedRatio = function()
{
	return Math.min(
		this.maxSpeed,
		this.speed+this.boost
...
RENDER.hexgl.ShipControls.prototype.getSpeedRatio = function()
{
	return (this.speed+this.boost)/ this.maxSpeed;
};

RENDER.hexgl.ShipControls.prototype.getBoostRatio = function()
{
	return this.boost / this.boosterSpeed;
};

RENDER.hexgl.ShipControls.prototype.getShieldRatio = function()
{
	return this.shield / this.maxShield;
};

RENDER.hexgl.ShipControls.prototype.getShield = function(scale)
{
	return Math.round(
		this.shield
		* (scale == undefined ? 1 : scale)
...
RENDER.hexgl.ShipControls.prototype.getPosition = function()
{
	return this.dummy.position;
}

RENDER.hexgl.ShipControls.prototype.getQuaternion = function()
{
