...
RENDER.hexgl.RaceData = function(track, mode, shipControls)
{
	this.track = track;
	this.mode = mode;
...
RENDER.hexgl.RaceData.prototype.tick = function(time)
{
	if(this.rateState == 1)
	{
...
RENDER.hexgl.RaceData.prototype.applyInterpolated = function(time)
{
...
RENDER.hexgl.RaceData.prototype.reset = function()
{
	this.seek = 0;
}

RENDER.hexgl.RaceData.prototype.export = function()
{
	return this.data;
}

RENDER.hexgl.RaceData.prototype.import = function(imp)
{
	this.data = imp;
