/*!
 * @class RENDER.threejs.Particles
 *
 ...
 */
RENDER.threejs.Particles = function(opts)
{
...
RENDER.threejs.Particles.prototype.build = function()
{
	...
	{
		var p = new RENDER.threejs.Particle();
		this.pool.push(p);
		this.buffer.push(p);
 ...
 * @param  int count
 */
RENDER.threejs.Particles.prototype.emit = function(count)
{
...
RENDER.threejs.Particles.prototype.randomVector = function()
{
 ...
 */
RENDER.threejs.Particles.prototype.update = function(dt)
{
	var p, l;
...
RENDER.threejs.Particle = function()
{
...
RENDER.threejs.Particle.prototype.reset = function()
{
