/*!
 * RENDER.threejs.RenderManager helps handling multiple scenes, cameras and render loops.
 * 
 * @author Thibaut 'RENDER' Despoulain <http://RENDER.com>
 * @license MIT
 * 
 * Initialize the a RenderManager by passing a Renderer object:
 * 		var renderManager = new RENDER.threejs.RenderManager(new THREE.WebGLRenderer());
 * 
...
RENDER.threejs.RenderManager = function(renderer)
{
...
RENDER.threejs.RenderManager.prototype.add = function(id, scene, camera, render, objects)
{
...
RENDER.threejs.RenderManager.prototype.get = function(id)
{
	return this.renders[id];
};

RENDER.threejs.RenderManager.prototype.remove = function(id)
{
...
RENDER.threejs.RenderManager.prototype.renderCurrent = function()
{
...
RENDER.threejs.RenderManager.prototype.setCurrent = function(id)
{
	if(id in this.renders)
	{
