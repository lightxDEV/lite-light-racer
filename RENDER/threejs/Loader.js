 ...
 */
var RENDER = RENDER || {};
RENDER.threejs = RENDER.threejs || {};

RENDER.NONE = undefined;

/**
 * Creates a new loader
 * @param {Object{onLoad, onError, onProgress}} opts Callbacks
 */
RENDER.threejs.Loader = function(opts)
{
	var self = this;
 ...
 */
RENDER.threejs.Loader.prototype.load = function(data)
{
	var self = this;
...
RENDER.threejs.Loader.prototype.updateState = function(type, name, state)
{
 ...
 * @return Mixed
 */
RENDER.threejs.Loader.prototype.get = function(type, name)
{
	if(!(type in this.types))
	{
		console.warn("Unkown loader type.");
...
RENDER.threejs.Loader.prototype.loaded = function(type, name)
{
	if(!(type in this.types))
	{
		console.warn("Unkown loader type.");
...
RENDER.threejs.Loader.prototype.loadTexture = function(name, url)
{
	var self = this;
...
RENDER.threejs.Loader.prototype.loadTextureCube = function(name, url)
{
	var self = this;
...
RENDER.threejs.Loader.prototype.loadGeometry = function(name, url)
{
	var self = this;
...
RENDER.threejs.Loader.prototype.loadAnalyser = function(name, url)
{
	var self = this;
	this.updateState("analysers", name, false);
	this.data.analysers[name] = new RENDER.ImageData(
		url, 
		function(){ 
...
RENDER.threejs.Loader.prototype.loadImage = function(name, url)
{
	var self = this;
...
RENDER.threejs.Loader.prototype.loadSound = function(src, name, loop){
    var self = this;
    this.updateState("sounds", name, false);
    
    RENDER.Audio.addSound(
    	src,
    	name, 
    	loop, 
    	function(){
    ...
    this.data.sounds[name] = {
        play: function(){
            RENDER.Audio.play(name);
        },
        stop: function(){
            RENDER.Audio.stop(name);
        },
        volume: function(vol){
            RENDER.Audio.volume(name, vol);
        }
    };
};